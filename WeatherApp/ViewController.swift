...
//  WeatherApp
//
//  Created by Kathryn Morrical on 1/17/17.
...
class ViewController: UIViewController, UISearchBarDelegate {
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        let urlRequest = URLRequest(url: URL(string: "http://api.apixu.com/v1/current.json?key=39dbd1fee6a04f54a6c183244171701&q=\(searchBar.text!.replacingOccurrences(of: " ", with: "%20"))")!)
